...
-(id) init
{
	if( (self=[super initWithColor:ccc4(150,50,50,255)])) {
        ...
        CCLabelTTF *endGameLabel = [CCLabelTTF labelWithString:@"" dimensions:CGSizeMake(150, 40) hAlignment:UITextAlignmentRight fontName:@"Marker Felt" fontSize:30];
        ...
        CCLabelTTF *welldoneLabel = [CCLabelTTF labelWithString:@"" dimensions:CGSizeMake(300, 40) hAlignment:UITextAlignmentRight fontName:@"Marker Felt" fontSize:30];
        ...
        CCLabelTTF *restartLabel = [CCLabelTTF labelWithString:@"Continue" dimensions:CGSizeMake(300, 40) hAlignment:UITextAlignmentRight fontName:@"Marker Felt" fontSize:30];
        ...
        CCLabelTTF *menuLabel = [CCLabelTTF labelWithString:@"Quit" dimensions:CGSizeMake(300, 40) hAlignment:UITextAlignmentRight fontName:@"Marker Felt" fontSize:30];
        ...
        replayButton = [CCMenuItemImage itemWithNormalImage:@"Buy.png" selectedImage:@"Buy.png" target:self selector:@selector(continueLevel)];
        
        menuButton = [CCMenuItemImage itemWithNormalImage:@"Cancel.png" selectedImage:@"Cancel.png" target:self selector:@selector(returnToMenu)];
